(function() {
  function extractTableData(depth = Infinity) {
    ...
    const table = document.querySelector(
      'div[data-qa-type="paragraph-output-tabls"] table, div[class^="_paragraphOutputTab_"] table, div[data-testid="output-content"] table'
    );
    if (table) {
      ...
      const rows = document.querySelectorAll(
        'div[data-qa-type="paragraph-output-tabls"] [data-output-table="row"], div[class^="_paragraphOutputTab_"] [data-output-table="row"], div[data-testid="output-content"] [data-output-table="row"]'
      );
